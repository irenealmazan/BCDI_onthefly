...
%%IN SITU NOVEMBER DATA PARAMS, for doing single scans

%particle 1
%snums= [400 401 403 404 421:425 429 430 434 439 440 442 445 447:453];


%particle 2
%snums = [575,584,587,590,595,597,609,616,622,624];

%particle 3
%snums=653:661;

%particle 4
%snums = [860 867 868 870:883 884 885 890];
snums= [879];
...
params.files={['S0' int2str(snums(tt)) '.mat']};
...
params.comments2 = ['part4' num2str(snums(tt))];

params.comments='singles to compare with mult phasing';      %write comments here and this will be saved in the params file
...
params.ALG2='DMr' ;                 %Algorithm 2.  must be in capitals
...
sx=40;%0.156*params.nn(1);                  %x,y,z support size (pixels)
