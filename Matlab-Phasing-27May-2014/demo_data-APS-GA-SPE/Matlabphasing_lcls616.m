...
%params.data_dir={'~/Documents/lcls_6_16/lclsdsets_allshot/'};  
params.data_dir={'~/Documents/lcls_6_16/lclsdsets/'};  
...
% used for displying the reconstructions
 ...
 Delta = 27;
 Gamma = 0;
 camdist = 1.5; % in meters

params.det_px=110e-6;               %detector pixel size (m)
...
params.ALG1='HIOlr' ;                  %Algorithm 1.  must be in capitals
...
sz=ceil(0.5*params.nn(3));   %x,y,z support size (pixels)
                %but you can put in pixel values as well
...
params.start_pcdi=ceil(3*params.iterations/4);               %start doing PCDI correction after this many iterations
