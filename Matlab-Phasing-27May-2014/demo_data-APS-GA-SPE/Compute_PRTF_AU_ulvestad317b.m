...
load('/Users/b228289/Documents/Ulvestad317bdsets/S1481.mat')

%%
%play_data(data)
data = sqrt(data);
data = init_crop(data,[-128 -128 -128 -128 0 0]);
%%
...
meas_abs=center_array_data(meas_abs);
...
[specscan, errors] = openspec('Ulvestad317b.spec', 1481);
