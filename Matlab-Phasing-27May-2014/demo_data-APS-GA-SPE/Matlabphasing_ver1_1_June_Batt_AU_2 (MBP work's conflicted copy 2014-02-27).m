...
snums=[35 40 42 43 44 45 46 47 49 50 51 52 55 56 57 58 59 63 68 69 72 73];

for tt = 12:length(snums)
...
params.files={[int2str(snums(tt)) '.tif']};
...
params.comments2 = ['J' num2str(snums(tt))];

params.comments='default';      %write comments here and this will be saved in the params file
...
params.threshold=0.2;                 %Shrinkwrap threshold (0<threshold<1).  threshold=0 will turn SW OFF.
...
%previous amplitudes w random phase
%support = abs(iterates(:,:,:,4));
...
datdir = ['/Users/a4894z/Desktop/recon/J' int2str(snum) 'r' int2str(i) '/'];
