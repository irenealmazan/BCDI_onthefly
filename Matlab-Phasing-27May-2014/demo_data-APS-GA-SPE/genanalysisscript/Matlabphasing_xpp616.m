...
files2{i}=sprintf('R%03d.hf',scannum(i));
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% 1. Data preperation
params.data_dir={'~/Desktop/Run107rjh/'};        %assumes data is in the same dir as this file
...
params.save_dir=dir;
                                ...
                                % same.
%to do individually
params.files={sprintf('R%03d.h5',scannum(tt))};
...
params.min_data=30;            %min data threshold.  below this is removed.  the 
