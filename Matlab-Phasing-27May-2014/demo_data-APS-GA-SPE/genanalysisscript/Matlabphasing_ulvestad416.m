...
params.min_data=2;            %min data threshold.  below this is removed.  the 
...
cd('/Volumes/34idc-acq/2016/Ulvestad416/')

[specscan, errors] = openspec('Ulvestad416b.spec',scannum(tt));
...
params.ALG2='ERlr' ;                 %Algorithm 2.  must be in capitals
