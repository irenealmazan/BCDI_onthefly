...
for   i=1:length(scannum2)
    ...
    %a
    %datdir = sprintf('/Volumes/34idc-acq/2016/Ulvestad416/Ulvestad416a_S%04d/',scannum);
    
    %b
    datdir = sprintf('/Volumes/34idc-acq/2016/Ulvestad416/Ulvestad416b_S%04d/',scannum);
