...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% 1. Data preperation
params.data_dir={'/Users/andrewulvestad/Dropbox/Matlab_phasing_AUG13/GA/'};            %assumes data is in the same dir as this file
...
params.files={'octahedron_data.mat'};%
...
params.comments2 = 'Smodel'; %first part of save name

params.comments='reconstruction of an octahedral particle';         %written in params.txt
...
params.iterations= 2020;             % Iterations to perform.
...
params.twin_it=25;                   %set twin=0 to turn off       
...
sx=30;                  %x,y,z support size (pixels)
sy=30;                  %i like to set them relative to the array dimensions   
sz=30;                  %but you can put in pixel values as well
...
params.phase_trigger=[1,25];         %same rules as for trigger and shrink_trigger
...
params.save_det2lab=0;           %save matlab in lab coords (yes=1). Makes x,y transverse to beam direction
