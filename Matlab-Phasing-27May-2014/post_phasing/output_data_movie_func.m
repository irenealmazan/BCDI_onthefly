function output_data_movie_func(dir_file,orientation)
%%
...
if bin(1) == 2,bin(1)=1;end
if bin(2) == 2,bin(2)=1;end
...
switch orientation
    ...
    case {'yz','zy'}
        ...
        for qq=1:zzc
            ...
            yz=extract_3D_slice(data,'yz',qq);
            yz=log10(yz);
            fh = figure(30) ; % returns the handle to the figure object
            set(fh, 'color', 'white'); % sets the color to white 
            imagesc(qy,qz,yz)
...
make_avi_from_images([dir_file,'/*.jpg'],[dir_file,'Data-',orientation,'.avi'],10,400); 
