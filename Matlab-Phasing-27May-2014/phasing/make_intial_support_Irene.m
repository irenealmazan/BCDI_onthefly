function [pn,support] = make_intial_support_Irene(data,ss,params)
%UNTITLED3 Summary of this function goes here

if numel(size(data)) == 3
    [support] = zero_pad_ver_Irene(params.nn(1),params.nn(2),params.nn(3),ones(ss));
...
% params.nn(3)/2-size(support_1,3)/2+1:params.nn(3)/2+size(support_1,3)/2)=support_1;
    ...
    [support] = zero_pad_ver_Irene(params.nn(1),params.nn(2),params.nn(3),ones([ss(1),ss(2)]));
    %support_1 = ones(ss);
    support = zeros(params.nn(1),params.nn(2),params.nn(3));
