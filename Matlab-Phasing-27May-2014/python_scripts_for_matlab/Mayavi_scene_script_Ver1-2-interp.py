...
for file0 in os.listdir('.'): 
	...
	enthought.mayavi.mlab.savefig(filename+'+SCP+X.ps', size=[500,500])
	scene1.scene.y_plus_view()
	scalar_cut_plane.implicit_plane.widget.origin = origin
	scalar_cut_plane.warp_scalar.filter.normal = array([ 1.,  0.,  0.])
	scalar_cut_plane.implicit_plane.widget.normal = array([ 1.,  0.,  0.])
	...
	enthought.mayavi.mlab.savefig(filename+'+SCP+Y.ps', size=[1500,1500])
	scene1.scene.z_plus_view()
	scalar_cut_plane.implicit_plane.widget.origin = origin
	scalar_cut_plane.warp_scalar.filter.normal = array([ 0.,  1.,  0.])
	scalar_cut_plane.implicit_plane.widget.normal = array([ 0.,  1.,  0.])
	...
	enthought.mayavi.mlab.savefig(filename+'+SCP+Z.ps', size=[1500,1500])
	scalar_cut_plane.implicit_plane.widget.origin = origin
	scalar_cut_plane.warp_scalar.filter.normal = array([ 0.,  0.,  1.])
	scalar_cut_plane.implicit_plane.widget.normal = array([ 0.,  0.,  1.])
	...
	scene1.scene.camera.zoom(zoom)
	scene1.scene.render()
	enthought.mayavi.mlab.savefig(filename+'+SCPh+X.png', size=[1500,1500])
	enthought.mayavi.mlab.savefig(filename+'+SCPh+X.ps', size=[1500,1500])
	...
	scene1.scene.camera.zoom(zoom)
	scene1.scene.render()
	enthought.mayavi.mlab.savefig(filename+'+SCPh+Y.png', size=[1500,1500])
	enthought.mayavi.mlab.savefig(filename+'+SCPh+Y.ps', size=[1500,1500])
	...
	scene1.scene.camera.zoom(zoom)
	scene1.scene.render()
	enthought.mayavi.mlab.savefig(filename+'+SCPh+Z.png', size=[1500,1500])
	enthought.mayavi.mlab.savefig(filename+'+SCPh+Z.ps', size=[1500,1500])
	module_manager1.scalar_lut_manager.show_scalar_bar = False
	module_manager1.scalar_lut_manager.show_legend = False
	scalar_cut_plane.implicit_plane.widget.origin = origin
	scalar_cut_plane.warp_scalar.filter.normal = array([ 0.,  0.,  1.])
	...
	enthought.mayavi.mlab.savefig(filename+'-T-SB-ISO.ps', size=[500,500])
