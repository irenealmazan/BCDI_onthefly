...
for file0 in os.listdir('.'): 
	...
	if os.path.isdir(dir+save_mname+'Ph'+str(thing)+'/') == False:
	    os.mkdir(dir+save_mname+'Ph'+str(thing)+'/')

	    
	filename=dir+save_mname+'Ph'+str(thing)+'/Ph-'
	#filename=dir+save_mname+'Ph/Ph-'
        

	this_dir=dir+save_mname+'Ph'+str(thing)+'/'
	thing=thing+1	
