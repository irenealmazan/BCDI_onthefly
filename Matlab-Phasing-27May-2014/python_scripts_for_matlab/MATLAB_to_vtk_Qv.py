...
for file0 in os.listdir('.'): 
	...
	if file0[len(file0)-7:] == 'COH.rec':
	    print 'Saving amplitude ...'
	    data=abs(data)
	else:
	    print 'Saving real component...'
	...
	#if fnmatch.fnmatch(file0[len(file0)-7:],'*COH.rec'):
	#        print file0[len(file0)-7:]
	#	print "Outputting amplitude only to VTK..."
	#	dDampsGM=vs.vtkStructuredGridMaker(NewCoords, dDcrop, c.AMP)	#c.AMP 
	#else:
	#	print file0[len(file0)-7:]
	#	print "Outputting real component to VTK..."
