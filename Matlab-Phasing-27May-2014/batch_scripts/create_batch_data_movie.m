function create_batch_data_movie
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here

name_of_this_file='create_batch_data_movie';
...
fid = fopen([dir,'batch_data_movie.m'], 'w');
...
for qq = 1:nn(1)
    ...
    fprintf(fid,'\n');
    fprintf(fid, 'output_data_movie_func(''');
    fprintf(fid, cur_dir);
    fprintf(fid,''')');
    fprintf(fid, '\n');
